...
CUDA_VISIBLE_DEVICES=6,7 torchrun --nproc_per_node=2 --nnodes=1 --node_rank=0 --master_port=8881 finetune.py \
    --base_model '/mnt/ckptstorage/user-fs/luankexin/lcq/checkpoints/Meta-Llama-3-8B' \
    --data_path 'math_10k.json' \
    --output_dir results_coling改进_osb_math_sr03_3epoch_8_4_8B_64 \
